...
public class ProductOrderController {
	...
	public ResponseEntity<?> geProductOrderByOrderId(@PathVariable(name = "orderId") short orderId) {
		List<ProductOrder> entities = service.geProductOrderByOrderId(orderId);
		return new ResponseEntity<>(entities, HttpStatus.OK);
	}
